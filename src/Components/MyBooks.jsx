    ...
    if (result.isConfirmed) {
      try {
        ...
        Swal.fire({
          icon: "error",
          title: "Delete failed",
          text: error.response?.data?.message || error.message || "Something went wrong while deleting.",
        });
      }
    }
  };
              ...
              <tbody>
                {books.map((book, index) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-3 font-medium truncate max-w-[180px]">{book.title}</td>
                    ...
                    <td className="px-4 py-3 text-center">
                      <div className="flex items-center justify-center gap-3 flex-wrap">
                        ...
                        <Tooltip anchorSelect={`#view-${book._id}`} content="View Book Details" className="bg-blue-700 text-white text-sm z-[9999]" />
                        <Link
                        ...
                        <Tooltip anchorSelect={`#edit-${book._id}`} content="Update this Book" className="bg-green-700 text-white text-sm z-[9999]" />
                        <button
                          id={`delete-${book._id}`}
                        ...
                        <Tooltip anchorSelect={`#delete-${book._id}`} content="Delete this Book" className="bg-red-700 text-white text-sm z-[9999]" />
                      </div>
                    </td>
                  </motion.tr>
                ))}
